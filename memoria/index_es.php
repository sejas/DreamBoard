...
<p>Nuestra aplicación se centra en la experiencia y contenido que pueda aportar el usuario, intentando seguir la filosofía de la WEB 2.0. Por ello hemos elegido las siguientes herramientas y tecnologías</p>
<h4> En el cliente </h4>
<ul id="tecnologias">
	<li>HTML5</li>
	<li>CSS3</li>
	<li>Javascript
		<ul>
			<li>jQuery</li>
			<li title="Libreria JavaScript para el desarrollo de juegos">box2d</li>
		</ul>
	</li>
	<li>WebGL</li>
</ul>
